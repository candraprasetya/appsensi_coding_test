...
//
//     final detailMovieModel = detailMovieModelFromMap(jsonString);
part of 'models.dart';

DetailMovieModel detailMovieModelFromMap(String str) =>
    DetailMovieModel.fromMap(json.decode(str));

String detailMovieModelToMap(DetailMovieModel data) =>
